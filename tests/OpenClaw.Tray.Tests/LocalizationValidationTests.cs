...
public class LocalizationValidationTests
{
    ...
    private static readonly HashSet<string> InvariantOrDeferredResourceKeys = new(StringComparer.Ordinal)
    {
        ...
        // Gateway session-maintenance controls are seeded English-only across
        // all locales until the next translation pass.
        "ConfigPage_Maintenance.Header",
        "ConfigPage_MaintenanceDescription.Text",
        "ConfigPage_MaintenanceMode.Header",
        "ConfigPage_MaintenanceEnforce.Content",
        "ConfigPage_MaintenanceWarn.Content",
        "ConfigPage_MaintenancePruneAfter.Header",
        "ConfigPage_MaintenancePruneAfter.PlaceholderText",
        "ConfigPage_MaintenanceMaxEntries.Header",
        "ConfigPage_MaintenanceArchiveRetention.Header",
        "ConfigPage_MaintenanceArchiveRetention.PlaceholderText",
        "ConfigPage_MaintenanceMaxDisk.Header",
        "ConfigPage_MaintenanceMaxDisk.PlaceholderText",
        "ConfigPage_MaintenanceHighWater.Header",
        "ConfigPage_MaintenanceHighWater.PlaceholderText",
        "ConfigPage_MaintenanceDisableArchiveExpiry.Header",
        "ConfigPage_MaintenanceLimitDisk.Header",
        "ConfigPage_MaintenanceModeError",
        "ConfigPage_MaintenancePruneAfterError",
        "ConfigPage_MaintenanceMaxEntriesError",
        "ConfigPage_MaintenanceArchiveRetentionError",
        "ConfigPage_MaintenanceMaxDiskError",
        "ConfigPage_MaintenanceHighWaterError",
